...
$VARS{RUNNING_MODE} = "Detect possible off-targets throughout the genome";
...
###### Name of the program.
$VARS{crista_exec_file} = "/bioseq/crista/CRISTA_online/bwa.py";
...
$VARS{RUNNING_PARAMS_TEXT} = $VARS{RUNNING_PARAMS_TEXT}."Genome assembly: ".$genomeAssembly."<br>";
...
sub run_calc {
    my $crista_comm;
    $crista_comm = "$VARS{crista_exec_file} -s $VARS{sgRNA_seq} -g $VARS{genomeAssembly}";
